...
- 37 testes e2e contra Postgres real cobrindo CRUD, isolamento entre tenants (RLS — inclusive um teste que verifica o privilégio da própria role de banco, não só o filtro da aplicação), RBAC, regras de negócio do PDV, desconto atômico de estoque, ciclo de vida financeiro, emissão fiscal (contingência/reemissão), recusa de pagamento pelo gateway, expiração de trial e convite/gestão de usuários (incluindo atomicidade quando o envio de e-mail falha)
